...
export const MIDDLE_EARTH = {
  ...
  factions: [
    ...
    { id: 'rangers-north', name: 'The Fellowship & Rangers of the North', color: '#4a6fa5', home: 'bree', alliance: 'me-good' },
    ...
    { id: 'lothlorien', name: 'Lothlórien', color: '#cfd8dc', home: 'caras-galadhon', alliance: 'me-good' },
    { id: 'woodland-realm', name: 'The Woodland Realm', color: '#1b8a3a', home: 'woodland-realm', alliance: 'me-good' },
    ...
    { id: 'fangorn-ents', name: "Fangorn's Ents", color: '#6b4f2a', home: 'fangorn', alliance: 'me-good' },
    { id: 'army-of-the-dead', name: 'The Army of the Dead', color: '#86b6a8', home: 'paths-of-the-dead', alliance: 'me-good' },
    ...
    { id: 'moria-goblins', name: "Moria's Goblins", color: '#566b2f', home: 'moria-west-gate', alliance: 'me-evil' },
    { id: 'angmar', name: 'Angmar', color: '#9fa8da', home: 'carn-dum', alliance: 'me-evil' },
    ...
    { id: 'corsairs-umbar', name: 'The Corsairs of Umbar', color: '#7f1d1d', home: 'umbar', alliance: 'me-evil' },
