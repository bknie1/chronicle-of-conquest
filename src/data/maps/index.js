...
export const MAPS = Object.fromEntries(
  [oldWorld, norsca, aqshy, ghyran, ghur, shyish, chamon, ulgu, hysh, azyr, eightpoints, blightCity, heresyGalaxy, galaxy40k, fantasyWorld].map(m => [m.id, m]),
);
